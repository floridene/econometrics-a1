...
```
As shown in the output (mod3ii) we can assume that e401k is independent from gender. We test if $H_0: \beta5 = 0$ in a two-sided test using $\alpha = 0.05$. As the p-value of 0.77 is bigger than 0.05 we cannot reject $H_0$. So, the probability of participating is independet of being male or female. 
